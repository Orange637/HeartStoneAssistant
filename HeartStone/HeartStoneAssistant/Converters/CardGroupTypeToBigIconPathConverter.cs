...
{
    public class CardGroupTypeToBigIconPathConverter : IValueConverter
    {
        ...
        {
            return string.Format("{0}{1}Big.png", BaseImagePath, Enum.GetName(typeof(CardGroupType), heroType));
        }
    }
}